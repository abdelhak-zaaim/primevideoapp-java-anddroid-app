...
public final class TrackSelectionDialog extends DialogFragment {
    ...
    public static TrackSelectionDialog createForTrackSelector(DefaultTrackSelector trackSelector, DialogInterface.OnDismissListener onDismissListener) {
        ...
        trackSelectionDialog.init(/* titleId= */ R.string.track_selection_title, mappedTrackInfo,/* initialParameters = */ parameters,
    ...
    private void init(int titleId, MappedTrackInfo mappedTrackInfo, DefaultTrackSelector.Parameters initialParameters,
                      boolean allowAdaptiveSelections,
                      boolean allowMultipleOverrides,
                      DialogInterface.OnClickListener onClickListener,
                      DialogInterface.OnDismissListener onDismissListener) {
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
            if (showTabForRenderer(mappedTrackInfo, i)) {
                ...
                tabFragment.init(mappedTrackInfo,/* rendererIndex= */ i,
    ...
    private static String getTrackTypeString(Resources resources, int trackType) {
        Log.e("getTrackTypeString", "=> " + trackType);
        switch (trackType) {
            case C.TRACK_TYPE_VIDEO:
    ...
    private final class FragmentAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            Log.e("valueAt", "=> " + tabFragments.toString());
        ...
        public CharSequence getPageTitle(int position) {
            Log.e("tabTrackTypes", "pos => " + tabTrackTypes.get(position).toString());
    ...
    public static final class TrackSelectionViewFragment extends Fragment
        ...
        public void init(MappedTrackInfo mappedTrackInfo, int rendererIndex, boolean initialIsDisabled, @Nullable SelectionOverride initialOverride,
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            trackSelectionView.init(mappedTrackInfo, rendererIndex, isDisabled, overrides, /* listener= */ this, this);
