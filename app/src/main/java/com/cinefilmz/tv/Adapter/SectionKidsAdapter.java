...
public class SectionKidsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int LANGUAGE = 30;
    private static final int CATEGORY = 40;
    ...
    public SectionKidsAdapter(Activity context, List<Datum> sectionDataList, String from, String videoType, String layoutType, String typeID) {
    ...
    ****************************************************** */
    ...
    public void onBindVideoHolder(VideoHolder holder, int position) {
        ...
        holder.lyContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("typeID", "==>> " + typeID);
                Utility.openDetails(context, "" + sectionDataList.get(position).getId(), "" + sectionDataList.get(position).getVideoType(),
    ...
    public void onBindLanguageHolder(LanguageHolder holder, int position) {
        ...
        if (!TextUtils.isEmpty(sectionDataList.get(position).getImage())) {
            Picasso.get().load(sectionDataList.get(position).getImage()).into(holder.ivThumb);
        }
        ...
        holder.ivThumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("videoType", "==>> " + videoType);
                Log.e("typeID", "==>> " + typeID);
                Utility.pushVideosByIDF(context, "ByLanguage", "" + sectionDataList.get(position).getId(), "" + sectionDataList.get(position).getName(),
                        "" + sectionDataList.get(position).getVideoType(), "" + layoutType, "" + sectionDataList.get(position).getTypeId());
            }
        });
    ...
    public void onBindCategoryHolder(CategoryHolder holder, int position) {
        ...
        holder.ivThumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("videoType", "==>> " + videoType);
                Log.e("typeID", "==>> " + typeID);
                Utility.pushVideosByIDF(context, "ByGenres", "" + sectionDataList.get(position).getId(), "" + sectionDataList.get(position).getName(),
                        "" + sectionDataList.get(position).getVideoType(), "" + layoutType, "" + sectionDataList.get(position).getTypeId());
            }
        });
