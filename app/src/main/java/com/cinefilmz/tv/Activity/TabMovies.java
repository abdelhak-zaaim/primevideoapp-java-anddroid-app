...
public class TabMovies extends AppCompatActivity implements View.OnClickListener {
    ...
    private String mainTitle = "", itemID = "", typeID = "";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tabmovies);
        PrefManager.forceRTLIfSupported(getWindow(), TabMovies.this);
        ...
        if (bundle != null) {
            ...
            txtToolbarTitle.setText("" + getResources().getString(R.string.title_movies));
    ...
    private void init() {
        try {
            prefManager = new PrefManager(TabMovies.this);
    ...
    private void SetBanner() {
        bannerAdapter = new BannerAdapter(TabMovies.this, bannerList, "Movies");
    ...
    private void SetContinueWatch() {
        continueWatchAdapter = new ContinueWatchAdapter(TabMovies.this, continueWatchingList, "Movies");
        rvContinueWatch.setLayoutManager(new LinearLayoutManager(TabMovies.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void SetDataDynamic() {
        try {
            for (int i = 0; i < sectionList.size(); i++) {
                Typeface face = Typeface.createFromAsset(TabMovies.this.getAssets(), "font/public_bold.ttf");
                ...
                LinearLayout lyMain = new LinearLayout(TabMovies.this);
                ...
                LinearLayout lyTitleDynamic = new LinearLayout(TabMovies.this);
                ...
                TextView txtTitleDynamic = new TextView(TabMovies.this);
                ...
                RecyclerView rvDataDynamic = new RecyclerView(TabMovies.this);
                rvDataDynamic.setLayoutParams(paramRecycleview);

                Log.e("==>VideoType", "" + sectionList.get(i).getVideoType());
                sectionHomeAdapter = new SectionHomeAdapter(TabMovies.this, sectionDataList, "Home", "" + sectionList.get(i).getVideoType(),
                        "" + sectionList.get(i).getScreenLayout(), "" + sectionList.get(i).getTypeId());
                rvDataDynamic.setLayoutManager(new LinearLayoutManager(TabMovies.this, LinearLayoutManager.HORIZONTAL, false));
