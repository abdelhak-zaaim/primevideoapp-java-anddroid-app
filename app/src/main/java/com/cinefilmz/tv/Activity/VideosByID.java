...
public class VideosByID extends AppCompatActivity implements View.OnClickListener {
    ...
    private RecyclerView rvVideosByID;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videobyid);
        PrefManager.forceRTLIfSupported(getWindow(), VideosByID.this);
        ...
        if (bundle != null) {
            ...
            if (viewAllType.equalsIgnoreCase("ByChannel")) {
                VideosByChannels();
            } else if (viewAllType.equalsIgnoreCase("ByBrowse")) {
                VideosByBrowse();
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (videoType.equalsIgnoreCase("ByChannel")) {
                            VideosByChannels();
                        } else if (viewAllType.equalsIgnoreCase("ByBrowse")) {
                            VideosByBrowse();
                        } else if (videoType.equalsIgnoreCase("ByGenres")) {
                            VideosByCategory();
    ...
    private void init() {
        try {
            prefManager = new PrefManager(VideosByID.this);
            ...
            rvVideosByID = findViewById(R.id.rvVideosByID);
        } catch (Exception e) {
...
//
//            case R.id.rlTVShows:
//                rgpContentType.check(R.id.rbTVShows);
//                break;
//
//            case R.id.rlMovies:
//                rgpContentType.check(R.id.rbMovies);
//                break;
        }
    }

    private void VideosByChannels() {
        allVideoList = new ArrayList<>();
        allVideosAdapter = new AllVideosAdapter(VideosByID.this, allVideoList, "ViewAll", "" + videoType, "landscape", "" + typeID);
        rvVideosByID.setLayoutManager(new GridLayoutManager(VideosByID.this, 2));
        rvVideosByID.setAdapter(allVideosAdapter);
                ...
                try {
                    ...
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        if (response.body().getResult().size() > 0) {
                            ...
                            allVideosAdapter = new AllVideosAdapter(VideosByID.this, allVideoList, "ViewAll", "" + videoType,
                                    "landscape", "" + typeID);
                            rvVideosByID.setLayoutManager(new GridLayoutManager(VideosByID.this, 2));
                            rvVideosByID.setAdapter(allVideosAdapter);
                            allVideosAdapter.notifyDataSetChanged();

                            rvVideosByID.setVisibility(View.VISIBLE);
                            lyNoData.setVisibility(View.GONE);
                        } else {
                            rvVideosByID.setVisibility(View.GONE);
