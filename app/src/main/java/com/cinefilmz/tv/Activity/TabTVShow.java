...
public class TabTVShow extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabtvshow);
        PrefManager.forceRTLIfSupported(getWindow(), TabTVShow.this);
    ...
    private void init() {
        try {
            prefManager = new PrefManager(TabTVShow.this);
    ...
    private void SetBanner() {
        bannerAdapter = new BannerAdapter(TabTVShow.this, bannerList, "TVShow");
    ...
    /* section_list API */
    private void TVShowSectionData() {
        Utility.shimmerShow(shimmer);
    ...
    private void SetContinueWatch() {
        continueWatchAdapter = new ContinueWatchAdapter(TabTVShow.this, continueWatchingList, "Home");
        rvContinueWatch.setLayoutManager(new LinearLayoutManager(TabTVShow.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void SetDataDynamic() {
        try {
            for (int i = 0; i < sectionList.size(); i++) {
                Typeface face = Typeface.createFromAsset(TabTVShow.this.getAssets(), "font/public_bold.ttf");
                ...
                LinearLayout lyMain = new LinearLayout(TabTVShow.this);
                ...
                LinearLayout lyTitleDynamic = new LinearLayout(TabTVShow.this);
                ...
                TextView txtTitleDynamic = new TextView(TabTVShow.this);
                ...
                RecyclerView rvDataDynamic = new RecyclerView(TabTVShow.this);
                rvDataDynamic.setLayoutParams(paramRecycleview);

                Log.e("==>VideoType", "" + sectionList.get(i).getVideoType());
                sectionHomeAdapter = new SectionHomeAdapter(TabTVShow.this, sectionDataList, "Home", "" + sectionList.get(i).getVideoType(),
                        "" + sectionList.get(i).getScreenLayout(), "" + sectionList.get(i).getTypeId());
                rvDataDynamic.setLayoutManager(new LinearLayoutManager(TabTVShow.this, LinearLayoutManager.HORIZONTAL, false));
